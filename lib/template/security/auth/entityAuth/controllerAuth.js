...
public class ${nameCapital}Controller {
    ...
    public Mono<ResponseLoginDto> login(@RequestHeader(HttpHeaders.AUTHORIZATION) String header){
        return this.${name}Service.login(header);
    }

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public Mono<Response${nameCapital}Dto> create(@Valid @RequestBody Create${nameCapital}Dto create${nameCapital}Dto){
        return  this.${name}Service.create(create${nameCapital}Dto);
    }
    
    @ResponseStatus(HttpStatus.OK)
    @GetMapping
    public Mono<Page<Response${nameCapital}Dto>> findAll(
    ...
    @ResponseStatus(HttpStatus.OK)
    @GetMapping("/{id}")
    public Mono<Response${nameCapital}Dto> findOne(@PathVariable("id") ${typeData} id){
        return this.${name}Service.findOne(id);
    }
        
    @ResponseStatus(HttpStatus.OK)
    @PatchMapping("/{id}")
    public Mono<Response${nameCapital}Dto> update(@Valid @RequestBody Update${nameCapital}Dto update${nameCapital}Dto, @PathVariable("id") ${typeData} id){
