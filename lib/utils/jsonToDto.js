...
const jsonToDto = async (name) => {
  ...
  try {
    ...
    console.log(`A dto was created with the name: ${nameResource.toLowerCase()}/services/dtos/${nameDto}Dto`.green);
  } catch (error) {
    console.log(`It was not possible to read the clipboard`.red)
  }
};
